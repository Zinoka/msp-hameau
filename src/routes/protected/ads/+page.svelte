        ...
        <div class="group">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Saisissez ici votre article"
              required
            ></textarea>
          </div>
          ...
          {#each data.articles as article}
            <tr>
              ...
              <td style="text-align: center;"
                >{article.enable ? "En ligne" : "Désactivé"}</td
              >
              <td class="td-buttons" style="text-align: center;">
                <button
                  class="admin-button-table"
                  on:click={() => goto("/" + article.id)}
                  style="margin-right: 5%;">Voir</button
                >
                <button
                  class="admin-button-table-status"
                  on:click={() => disableArticle(article)}
                  >{article.enable ? "Désactiver" : "Réactiver"}</button
                >
              </td>
            </tr>
          {/each}
  ...
  <div class="footer-text">
    <p style="margin-top: 1vh; margin-bottom: 10px;">
      © 2025 Copyright Maison de Santé Pluriprofessionnelle du Hameau - <button
        ...
        class="rgpd-button"
        style="margin-top: 1vh; margin-bottom: 10px;">Mentions légales</button
      >
    </p>
